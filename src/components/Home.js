    ...
    return (
      <div className="main-content home">
        ...
        <p>
          ...
          directory app offers a preview of our course library. Choose from
          many hours of content, from HTML to CSS to JavaScript. Learn to
          code and get the skills you need to launch a new career in front
          end web development.
        </p>
        <p>
          We have thousands of videos created by expert teachers on web
          design and front end development. Our library is continually
          refreshed with the latest on web technology so you will never fall
          behind.
        </p>
        <hr />
        <h3>Featured Teachers</h3>
        <Link to="teachers/HTML/Tommy-Wingo">Tommy Wingo</Link>
        <Link to="teachers/JavaScript/Guil-Hernandez">Guil Hernandez</Link>
        <Link to="teachers/CSS/Treasure-Porth">Treasure Porth</Link>
        <Link to="teachers/JavaScript/Jay-McGavern">Jay McGavern</Link>
